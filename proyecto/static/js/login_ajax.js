...
let contentLogin = document.querySelectorAll(".login__view"); 
let imgPortadaMain = document.querySelector(".img-portada");
let imgPortadaUser = document.querySelector(".img__portada-user");
...
async function obtencionDatos() {
   ...
   `;
   inform.innerHTML = alertText;
   imgPortadaMain.style.display = "none";
   imgPortadaUser.style.display = "initial"; 
}